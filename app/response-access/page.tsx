...
function createDraft(): AccessDraft {
  return {
    ...
    accessCode: "",
    workshopIds: [],
    permissions: { exportCsv: false, manageConfirmations: false, revealContact: false, viewAnswers: true },
    active: true,
    expiresAt: ""
  };
}
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
          ...
          <div className="mt-7 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div><p className="text-sm font-black text-slate-700">Permissions</p><div className="mt-3 divide-y divide-slate-200 border-y border-slate-200">
              ...
              <PermissionRow checked={draft.permissions.manageConfirmations} description="Confirm calls, add notes, mark repeaters and carry forward" icon={ClipboardCheck} label="Manage call confirmations" onChange={(value) => updatePermission("manageConfirmations", value)} />
