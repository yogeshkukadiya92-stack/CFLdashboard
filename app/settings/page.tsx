  ...
  return (
    ...
    >
      <a className="flex items-center justify-between gap-4 rounded-3xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-100" href="/settings/sales-access">
        <span className="flex items-center gap-4"><span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-emerald-600 text-white"><KeyRound className="size-5" /></span><span><strong className="block text-lg font-black text-slate-950">Sales Access Management</strong><span className="mt-1 block text-sm font-semibold text-slate-600">Set page-wise CRM permissions for every salesperson.</span></span></span><span className="rounded-xl bg-white px-4 py-2 text-sm font-black text-emerald-700">Manage access</span>
      </a>
