        ...
        {showData ? (
          <section className="rounded-3xl border border-indigo-100 bg-indigo-50 p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-black text-slate-950">Preview Data</p>
                <p className="text-sm font-bold text-indigo-700">{fullName} | {mobile || "No mobile"} | {group || "No group"} | {isActive ? "Active" : "Inactive"}</p>
              </div>
            </div>
          </section>
        ) : null}
