...
import { findSalesPersonByCode, salesPersonCodeFromId } from "@/lib/sales-person-code";
import {
  ArrowLeft,
  ArrowRight,
  CalendarClock,
...
type SalesPerson = { id: string; isActive: boolean; name: string; salesPersonCode?: string };
...
export default function LeadsPage() {
  ...
  function downloadImportSample() {
    const csv = [
      ["Name", "Mobile", "Email", "City", "Country", "Source", "Workshop", "Stage", "Priority", "Salesperson ID", "Assigned To"],
      ["Sample Lead", "9876543210", "sample@example.com", "Surat", "India", "Referral", "Healthy Forever", "New", "Warm", "SP-12345678", ""]
